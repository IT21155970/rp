...
function ResearchGap() {
  return (
    <div className="text-center mt-5 py-8 md:py-12 max-w-6xl mx-auto px-3 md:px-4">
      ...
      >
        {/* ✅ Heading color changed to green */}
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-green-700">
          Research Gap
        </h2>

        {/* ✅ Paragraph and list text set to black */}
        <div className="text-left space-y-5 text-black leading-relaxed text-base md:text-lg">
          <p>
          ...
          <div className="bg-green-50 p-5 rounded-lg shadow-sm">
            {/* Optional: Keep this subheading blue for clarity */}
